...
1. Developing a Culinary Program dedicated to preparing incredible meals.
2. Using a wildcard to create an Executive Chef role who would lead that team.
3. Employing associates (folks described as having summer-job level training) in roles outside the obvious stocking or cashier roles.
4. Putting a writer and a product manager together to support customer engagement for the kitchen.
5. Using a wildcard to handle the obvious, but overlooked task of cleanup.
